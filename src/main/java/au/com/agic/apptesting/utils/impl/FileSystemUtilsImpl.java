		...
		return Try.of(() -> new PathReference(Paths.get(resPath), null))
			...
			.orElse(() -> Try.of(() -> {
				/*
					...
					which looks like:
					jar:https://github.com/mcasperson/IridiumApplicationTesting/releases/download/0.0.18/IridiumApplicationTesting.jar!/zap

					getSchemeSpecificPart() will return:
					https://github.com/mcasperson/IridiumApplicationTesting/releases/download/0.0.18/IridiumApplicationTesting.jar!/zap
				 */
