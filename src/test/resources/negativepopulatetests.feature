Feature: Negative step tests
  ...
  Scenario: Negative populate test 4
    Given I open the page "http://google.com"
    Then I populate the element with the attribute of "nope" equal to "nope" with "nope"
  ...
  Scenario: Negative populate test 8
    Given I open the page "http://google.com"
    Then I populate the hidden element found by "nope" with "nope"

  @neg-populate-9
  Scenario: Negative populate test 9
    Given I open the page "http://google.com"
    Then I populate the hidden element with the css selector of "nope" with "nope"